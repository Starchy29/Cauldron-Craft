...
public class MovementAbility : Move
{
    ...
    public MovementAbility(string name) : base(name, 1, MoveType.Movement, Targets.StandableSpot, PathSelector.Singleton, null, walkAnimator, "Reposition to a nearby tile.") {
